        ...
        <div class="main__wrapper">
            ...
            <div class="breadcrumb">
                <ul class="breadcrumb__list wrapper">
                    ...
                    <li class="breadcrumb__item">
                        <a href="catalog.php" class="breadcrumb__link">Отзывы</a>
                    </li>
                </ul>
            </div>
            ...
            <section class="about-reviews">
                <div class="about-reviews__wrapper wrapper wrapper_md">
                    ...
                    <h4 class="site-title about-reviews__title">Отзывы</h4>
                    ...
                    <div class="about-reviews__list">
                        ...
                        <div class="about-reviews__item about-reviews__item_flex">
                            ...
                            <button data-bind="modal_review_button" class="site-more about-reviews__more">Отзыв полностью
                            </button>
                        ...
                        <ul class="pagination pagination_reviews pagination">
